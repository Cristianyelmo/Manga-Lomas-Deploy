...
const {ratingselected} = UserHook()
  ...
  return (
     <div className="">
      <section className="  grid lg:grid-cols-2 grid-cols-1 gap-5  p-[20px] ">
      ...
      <section className="p-4">
        ...
        {dataproductsforid && dataproductsforid.producto.Calificacion.length !== 0 ? dataproductsforid.producto.Calificacion.map((item,index) => (
          <section key={index} className="flex flex-col md:flex-row text-black mt-6 border-black border-[4px] p-4">
            ...
            <div className="flex flex-col w-full">
              ...
              <p className="text-sm text-center md:text-left">{item.comentario}</p>
            </div>
          </section>
        ))
        ...
        <div className="text-black text-center flex flex-col items-center p-4">
          <Image
